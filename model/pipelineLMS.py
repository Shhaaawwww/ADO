...
class CatVTONPipeline:
    def __init__(
        ...
        self.noise_scheduler = LMSDiscreteScheduler.from_pretrained(base_ckpt, subfolder="scheduler")
    ...
    def attack(
        ...
        **kwargs,
        ...
        for i in range(attack_steps):
            ...
            # --- 1. Calculate losses (with gradients) ---
            optimizer.zero_grad()
            ...
            # Decode image for calculating regularization loss
            ...
            with torch.no_grad():
                ...
                # Recalculate reference image, ensure in no_grad
                ...
                with open("metrics_logLMS.txt", "a") as f:
                    f.write(f"{metrics}\n")
