...
class CatVTONPipeline:
    def __init__(
        ...
        self.noise_scheduler = EulerDiscreteScheduler.from_pretrained(base_ckpt, subfolder="scheduler")
    ...
    def attack(
        ...
        **kwargs,
        ...
        for i in range(attack_steps):
            ...
            # Decode images for regularization loss calculation
            ...
            with torch.no_grad():
                ...
                with open("metrics_logEuler.txt", "a") as f:
                    f.write(f"{metrics}\n")
