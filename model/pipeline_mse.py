...
class CatVTONPipeline:
    ...
    def attack(
        ...
        patience: int = 10,  # New: how many steps to wait before reducing learning rate
        **kwargs,
    ):
        ...
        print("Target result calculation completed, starting optimization loop...")
        ...
        for i in range(attack_steps):
            ...
            loss1 = torch.nn.functional.mse_loss(target_result_latent, result_latent)
            ...
            # loss2 = torch.nn.functional.mse_loss(condition_image0, ref_condition_image0)
