...
def get_opt():
    ...
    parser.add_argument('--dataset_dir', type=str, default='/mnt/NewSSD/wenjun/VTOFF/vitonhd')
...
class VITONDataset(data.Dataset):
    ...
    def get_img_agnostic(self, img, parse, pose_data):
        ...
        x[:] = 0
        x = Image.fromarray(x)
        agnostic_draw = ImageDraw.Draw(x)
    ...
    def __getitem__(self, index):
        ...
        img_agnostic.save(osp.join("/mnt/NewSSD/wenjun/VTOFF/vitonhd_tmp", img_name.replace('.jpg', '_mask.png')))
